...
import json
import pandas as pd
from scrapper import fantasy_stats
import warnings

warnings.filterwarnings('ignore')

LOAD_PLAYERS_TEAMS = 1
LOAD_CREDITS = 1
ROUND = 3
...
if __name__ == "__main__":
    ...
    if LOAD_PLAYERS_TEAMS:
        ...
        for round in range(1, ROUND + 1):
            ...
            for player_id, player_name, team, round, minutes, valuation in zip(round_stats['Player_ID'], round_stats['Player'],
                                                                      round_stats['Team'], round_stats['Round'], round_stats['Minutes'], round_stats['Valuation']):
